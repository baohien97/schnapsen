...
class Deck:
    ...
    def generate(id=None, project= True):
        ...
        if project:
            # put King of Trump suit on Player 1's hand
            trump_suit = shuffled_cards[0] / 5
            trump_king_state = ""
            trump_king_index = 0
            trump_queen_state = ""
            trump_queen_index = 0
            ...
            for j in range(20):
                if shuffled_cards[j] / 5 == trump_suit and shuffled_cards[j] % 5 == 2:
                    ...
                    trump_king_index = j
                elif shuffled_cards[j] / 5 == trump_suit and shuffled_cards[j] % 5 == 3:
                    trump_queen_state = card_state[shuffled_cards[j]]
                    trump_queen_index = j
